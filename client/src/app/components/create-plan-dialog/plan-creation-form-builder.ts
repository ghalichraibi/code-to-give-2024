...
import { Intervention } from "@common/interfaces/documents/intervention-plan.interface";
...
export class PlanCreationFormBuilder {
    ...
    async getTreatmentTeamOptions() {
        const response = await firstValueFrom(this.communicationService.getAllCaregivers()); // TODO: modify this to treatment team
